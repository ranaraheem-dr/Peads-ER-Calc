...
{ name : "Plan C (Severe - 30% fluid)", dose: 30, frequency: "ml/kg", formula: "<span class='centered-text'>Over 30 mins
  in child and 1 hr in infant</span>" },
{ name : "Plan C (Severe - 70% fluid)", dose: 70, frequency: "ml/kg", formula: "<span class='centered-text'>Over 5 hrs
  in infant and 2.5 hrs in child</span>" },
];
...
{ name : "Collistin min", dose: 25000, frequency: "IU/kg/dose", formula: "75,000IU/kg/day calc dose is divided into tds"
},
{ name : "Collistin max", dose: 50000, frequency: "IU/kg/dose", formula: "150,000IU/kg/day calc dose is divided into
tds" },
...
{ name : "Streptomycin Min", dose: 500000, frequency: "IU/kg/dose", formula: "500000IU/kg/dose" },
{ name : "Streptomycin Max", dose: 1000000, frequency: "IU/kg/dose", formula: "1000000IU/kg/dose" },
...
{ name : "Solucortif", dose: 5, frequency: "mg/kg/dose", formula: "5mg/kg/dose 6hrly" },
...
{ name : "Atem <1 year", dose: 1, frequency: "ml/dose" , formula: "Nebulised over 15-20 min" }, { name : "Atem >1 year"
  , dose: 2.5, frequency: "ml/dose" , formula: "Nebulised over 15-20 min" }, ]; const bronchodilators=[ { name
  : "Terbutaline loading min" , dose: 2, frequency: "mcg/kg/min" , formula: "Given as continuous infusion" }, { name
  : "Terbutaline loading max" , dose: 10, frequency: "mcg/kg/min" , formula: "Given as continuous infusion" }, { name
  : "Terbutaline maintenance min" , dose: 0.2, frequency: "mcg/kg/min" , formula: "Given as continuous infusion" }, {
  name : "Terbutaline maintenance max" , dose: 0.4, frequency: "mcg/kg/min" , formula: "Given as continuous infusion" },
  { name : "Mgso4 min" , dose: 25, frequency: "mg/kg/dose" , formula: "25mg/kg" }, { name : "Mgso4 max" , dose: 50,
  frequency: "mg/kg/dose" , formula: "50mg/kg" }, ]; const hypercyanoticspells=[ { name : "Esmolol 100mcg" , dose: 100,
  frequency: "mcg/kg/dose" , formula: "100-500 mcg/kg over 1 minute" }, { name : "Esmolol 200mcg" , dose: 200,
  frequency: "mcg/kg/dose" , formula: "100-500 mcg/kg over 1 minute" }, { name : "Esmolol 500mcg" , dose: 500,
  frequency: "mcg/kg/dose" , formula: "100-500 mcg/kg over 1 minute" }, { name : "Morphine" , dose: 0.1,
  frequency: "mg/kg/dose" , formula: "0.1 mg/kg IV, IM, SC" }, { name : "Phenylephrine 5mcg" , dose: 5,
  frequency: "mcg/kg/dose" , formula: "5-20 mcg/kg every 10-15 minutes" }, { name : "Phenylephrine 20mcg" , dose: 20,
  frequency: "mcg/kg/dose" , formula: "5-20 mcg/kg every 10-15 minutes" }, { name : "Propranolol 0.015" , dose: 0.015,
  frequency: "mg/kg/dose" , formula: "0.015-0.02 mg/kg IV" }, { name : "Propranolol 0.02" , dose: 0.02,
  frequency: "mg/kg/dose" , formula: "0.015-0.02 mg/kg IV" }, ]; const syrups=[ { name : "Syp. Amoxil" ,
  dosage: "50mg/kg/day" , formulation: "125mg/5ml" , frequency: "BD/TDS" , max: "1g/day" }, { name : "Syp. Calamox" ,
  dosage: "30-50mg/kg/day" , formulation: "156mg/5ml" , frequency: "BD/TDS" }, { name : "Syp. Azit" ,
  dosage: "12-15mg/kg/day" , formulation: "200mg/5ml" , frequency: "OD" }, { name : "Syp. Flagyl" ,
  dosage: "20-30mg/kg/day" , formulation: "100mg/5ml" , frequency: "BD/TDS" }, { name : "Syp. Septran" ,
  dosage: "50-60mg/kg/day" , formulation: "200/40mg/5ml" , frequency: "BD" }, { name : "Syp. Velosef" ,
  dosage: "25-50mg/kg/day" , formulation: "125mg/5ml" , frequency: "BD" }, { name : "Syp. Nitazide" , dosage: "100mg BD"
  , formulation: "100mg/5ml" , frequency: "BD" } ]; const reversals=[ { name : "Atropine" , dose: 0.01,
  frequency: "mg/kg/dose" , formula: "0.01-0.02 mg/kg IV" }, { name : "Edrophonium" , dose: 0.2, frequency: "mg/kg/dose"
  , formula: "0.2 mg/kg IV" }, { name : "Flumazenil" , dose: 0.01, frequency: "mg/kg/dose" , formula: "0.01 mg/kg IV" },
  { name : "Glycopyrrolate" , dose: 0.005, frequency: "mg/kg/dose" , formula: "0.005-0.01 mg/kg IV" }, { name : "Narcan"
  , dose: 0.01, frequency: "mg/kg/dose" , formula: "0.01-0.1 mg/kg/dose IV" }, { name : "Neostigmine" , dose: 0.05,
  frequency: "mg/kg/dose" , formula: "0.05-0.07 mg/kg IV" }, { name : "Physostigmine" , dose: 0.01,
  frequency: "mg/kg/dose" , formula: "0.01 mg/kg IV" }, ]; const insulin=[ { name : "Insulin" , dose: 0.02,
  frequency: "U/kg/hr" , formula: "0.02-0.1 U/kg/hr" }, ]; const bloodproducts=[ { name : "Platelets" , dose: 5,
  frequency: "ml/kg/dose" , formula: "5-10 ml/kg will raise count 50-100x10^9/L" }, { name : "PRBC" , dose: 10,
  frequency: "ml/kg/dose" , formula: "10 ml/kg will raise Hg by 1 gm" }, { name : "FFP" , dose: 10,
  frequency: "ml/kg/dose" , formula: "10 ml/kg will raise the platelet count by 50,000-100,000/uL" }, ]; const
  hyperkalemia=[ { name : "Dextrose" , dose: 0.5, frequency: "g/kg/dose" , formula: "0.5-1 g/kg IV over 15 min" }, {
  name : "Insulin" , dose: 0.2, frequency: "U/g Dextrose" , formula: "0.2-0.3 U Reg Insulin/g Dextrose" }, { name
  : "Ca++" , dose: 4, frequency: "mg/kg/dose" , formula: "4-5 mg/kg IV over 5-10 min" }, { name : "Kayexelate" , dose:
  1, frequency: "gm/kg/dose" , formula: "1-2 gm/kg PO, PR" }, ]; const infusions=[ { name : "Dopamine" , dose: 5,
  frequency: "mcg/kg/min" , formula: "Given as continuous infusion" }, { name : "Adrenaline 0.05mcg" , dose: 0.05,
  frequency: "mcg/kg/min" , formula: "0.05 mcg/kg/min" }, { name : "Adrenaline 0.1mcg" , dose: 0.1,
  frequency: "mcg/kg/min" , formula: "0.1 mcg/kg/min" }, { name : "Nor-Adrenaline 0.05mcg" , dose: 0.05,
  frequency: "mcg/kg/min" , formula: "0.05 mcg/kg/min" }, { name : "Nor-Adrenaline 0.1mcg" , dose: 0.1,
  frequency: "mcg/kg/min" , formula: "0.1 mcg/kg/min" }, { name : "Fentanyl 1mcg" , dose: 1, frequency: "mcg/kg/hr" ,
  formula: "1 mcg/kg/hr" }, { name : "Fentanyl 4mcg" , dose: 4, frequency: "mcg/kg/hr" , formula: "4 mcg/kg/hr" }, {
  name : "Lasix 0.3mg" , dose: 0.3, frequency: "mg/kg/hr" , formula: "0.3mg/kg/hr" }, { name : "Lasix 1mg" , dose: 1,
  frequency: "mg/kg/hr" , formula: "1 mg/kg/hr" }, { name : "Aminophylline" , dose: 1, frequency: "mg/kg/hr" ,
  formula: "1 mg/kg/hr" }, { name : "Heparin 10 unit" , dose: 10, frequency: "unit/kg/hr" , formula: "10 unit/kg/hr" },
  { name : "Heparin 40 unit" , dose: 40, frequency: "unit/kg/hr" , formula: "40 unit/kg/hr" }, { name
  : "Morphine 10 mcg" , dose: 10, frequency: "mcg/kg/hr" , formula: "10 mcg/kg/hr" }, { name : "Morphine 30 mcg" , dose:
  30, frequency: "mcg/kg/hr" , formula: "30 mcg/kg/hr" }, { name : "Morphine 60 mcg" , dose: 60, frequency: "mcg/kg/hr"
  , formula: "60 mcg/kg/hr" }, { name : "Dobutamine" , dose: 5, frequency: "mcg/kg/min" ,
